...
"""
    find_eigenvalue(r, m, c; tol=1e-12, max_iter=20, num_terms= 12)
"""
...
λᵐₙ(c) for small values of c

Reference: Pag. 754 Abramowitz and Stegun 
"""
function ps_λ(m, n, c)
    ℓ₀ = n * (n + 1)
...
"""
    ...
    Pag. 754 Abramowitz and Stegun
"""
function asymp_λ_obl(m, n, c)                                                                                         
    q = 2*(n-m)+1                                                                                                                                                                              
